...
namespace Hrm.Service
{
    public partial class SalaryService : ISalaryService
    {
        ...
        public string GetSalary(BasicParamType param, int payrollId, int month, int year, long staffId, out string outTotalJson, out int totalRecord)
        {
            var response = _salaryRepository.GetSalary(param, payrollId, month, year, staffId, out outTotalJson, out totalRecord);
            return JsonConvert.SerializeObject(response);
        }
    }
}
