function BuildTable(appName, controllerName, tableUrl) {
    app.controller(controllerName,
        function ($scope, myService, $filter, $rootScope, $compile) {
            ...
            $scope.showreportl = false;
            $scope.showreportldepartment = true;
            ...
            $scope.getTableInfo = function () {
                ...
                if ($scope.status == 0) {
                    ...
                    $scope.showreportl = true;
                    $scope.showreportldepartment = false;
                }
            ...
            $scope.GetListData = function () {
                ...
                $scope.startdate2 = x1 + " 00:00:00";
                $scope.enddate2 = y1 + " 00:00:00";
                ShowLoader();
                var data = {
