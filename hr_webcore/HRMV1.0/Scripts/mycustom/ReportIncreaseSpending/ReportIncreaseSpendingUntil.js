function BuildTable(appName, controllerName, tableUrl, viewType) {
    app.controller(controllerName,
        function ($scope, myService, $filter, $rootScope, $window, $http, $timeout) {
            ...
            setTimeout(function () { $('.col-md-2.selectdiv').hide(); }, 2500);
            $rootScope.data = {
                filter5: '',
                filter1: '',
                filter2: '',
