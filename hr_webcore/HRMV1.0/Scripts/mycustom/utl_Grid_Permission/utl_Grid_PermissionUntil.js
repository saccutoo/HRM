    ...
    app.controller(controllerName,
        function ($scope, myService, $filter, $rootScope, $compile) {
            ...
            $scope.Save = function () {
                ...
                var SaveAction = myService.UpdateData("/utl_Grid_Permission/utl_Grid_Permission_Save", $scope.EditData);
                SaveAction.then(function (res) {
                    if (res.data.result.IsSuccess == true) {
                        ...
                        $scope.utl_Grid_PermissionData.reload();
                        $scope.EditData = {};
                        $scope.CloseForm();
                    }
                    else {
            ...
            $scope.editClick = function (contentItem) {
                ...
                $scope.EditData.IsAdd = contentItem.IsAdd;
                $scope.EditData.IsEdit = contentItem.IsEdit;
                $scope.EditData.IsDelete = contentItem.IsDelete;
                $scope.EditData.IsActive = contentItem.IsActive;
                $scope.EditData.IsFilterButton = contentItem.IsFilterButton;
                $scope.EditData.IsExportExcel = contentItem.IsExportExcel;
                $scope.EditData.IsImportExcel = contentItem.IsImportExcel;
                $scope.EditData.IsSubmit = contentItem.IsSubmit;
                $scope.EditData.IsApproval = contentItem.IsApproval;
                $scope.EditData.IsDisApproval = contentItem.IsDisApproval;
                $scope.EditData.IsCopy = contentItem.IsCopy;
