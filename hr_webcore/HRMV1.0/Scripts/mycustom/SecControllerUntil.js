...
//                    }
            ...
            $scope.editClick = function (contentItem) {
                var edit = myService.getDataById(contentItem.ControllerID, $scope.tableInfo.id, $scope.tableInfo.DataEditUrl);
            ...
            $scope.deleteActionClick = function (obj) {
                ...
                var action = myService.deleteAction(obj.ControllerID, $scope.tableInfo.id, $scope.tableInfo.DeleteUrl);
