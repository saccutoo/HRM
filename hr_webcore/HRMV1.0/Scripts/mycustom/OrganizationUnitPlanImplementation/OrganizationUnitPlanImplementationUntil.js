        ...
        function ($scope, myService, $filter, $rootScope, $compile, $http) {
            ...
            $scope.ListContractTypeName = function () {
                ...
                list.then(function (res) {
                    ...
                    $rootScope.ListContractTypeName = $scope.ListContractTypeName;
            ...
            $scope.GetListStatus = function () {
                ...
                list.then(function (res) {
                    ...
                    for (var i = 0 ; i < $scope.getListStatus.length ; i++) {
                        $scope.getListStatus[i].Value = parseInt($scope.getListStatus[i].Value) == 0 ? 'zero' : $scope.getListStatus[i].Value;
                    }
                },
                   function (res) {
                       scope.msg = "Error";
            ...
            $scope.addClick = function () {
                ...
                $scope.Data.Year = yyyy;
                ShowPopup($,
                    "#OrganizationUnitPlanImplementationSave",
            ...
            $scope.EditClick = function (employee) {
                ...
                if (employee.OrganizationUnitID != null) {
                    employee.Data.OrganizationUnitID = employee.OrganizationUnitID;
                }
                ...
                if (employee.ContractType != null) {
                    employee.Data.ContractType = employee.ContractType;
                }
            ...
            $scope.ChangeOrganizationUnit = function (employee) {
                if (employee.Data.OrganizationUnitID == null || employee.Data.OrganizationUnitID == "") {
                    ...
                    for (var i = 0; i < $scope.getListAllOrganizationUnit.length; i++) {
                        if ($scope.getListAllOrganizationUnit[i].OrganizationUnitID == employee.Data.OrganizationUnitID) {
            ...
            $scope.SaveEditClick = function (tblDatas) {
                ...
                for (var i = 0; i < $scope.employees.length; i++) {
                    if ($scope.employees[i].Data != null) {
                        ...
                        //---------------Bắt lỗi khi chưa chọn phòng ban---------------------
                        if ($scope.employees[i].Data.OrganizationUnitID == null || $scope.employees[i].Data.OrganizationUnitID == "") {
                        ...
                        if ($scope.employees[i].Data.OrganizationUnitID == null || $scope.employees[i].Data.OrganizationUnitID == "") {
                            ...
                            if ($scope.employees[i].Data.OrganizationUnitID == null || $scope.employees[i].Data.OrganizationUnitID == "") {
                                ...
                                if ($scope.employees[i].Data.ContractType == null || $scope.employees[i].Data.ContractType == "") {
                                    $scope.employees[i].Data.ContractType = 0;
                                }
                ...
                for (var i = 0; i < $scope.employees.length; i++) {
                    if ($scope.employees[i].Data != null) {
                        if ($scope.employees[i].Data.Status == 'zero' && $scope.employees[i].Data.Status != null) {
                ...
                if ($scope.Data.length>0 && $scope.Data!=null) {
                    var SaveAction = myService.UpdateData("/OrganizationUnitPlanImplementation/OrganizationUnitPlanImplementation_Save", $scope.Data);
                    SaveAction.then(function (res) {
                        if (res.data.result.IsSuccess == true) {
                            AppendToToastr(true, notification, successfulUpdate, 500, 5000);
                            $scope.OrganizationUnitPlanImplementationData.reload();
                            $scope.Data = [];
                            $scope.CloseForm();
                        }
                        else {
            ...
            $scope.downLoadFileClick = function () {
                window.location = "/OrganizationUnitPlanImplementation/DownloadTemplate";
            }
            ...
            $scope.upload = function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: "/OrganizationUnitPlanImplementation/ImportExcel",
                    data: $formData,
                    processData: false,
                    contentType: false,
                    beforeSend: function () {
                    ...
                    success: function (data) {
                        ...
                        if (data1.SM.IsSuccess == false) {
                            ...
                            if (data1 != null && data1.result.length > 0) {
                                window.location = "/OrganizationUnitPlanImplementation/ExportOrganizationUnitPlanImplementationDataError";
                            }
                            else {
            ...
            $scope.ChangeAddOrganizationUnit = function () {
                if ($scope.Data.OrganizationUnitID == null || $scope.Data.OrganizationUnitID == "") {
                    ...
                    $scope.ErrorOrganizationUnit = "";
                    for (var i = 0; i < $scope.getListAllOrganizationUnit.length; i++) {
                        if ($scope.getListAllOrganizationUnit[i].OrganizationUnitID == $scope.Data.OrganizationUnitID) {
            ...
            $scope.Save = function () {              
                ...
                if ($scope.Data.Year == null || $scope.Data.Year == "") {
                    ...
                    if ($scope.Data.ContractType == null || $scope.Data.ContractType == "") {
                        $scope.Data.ContractType = 0;
                    }
                    $scope.ListData = [];
                    if ($scope.Data.Status == 'zero' && $scope.Data.Status!=null) {
                        $scope.Data.Status = 0;
                    }
                    $scope.ListData.push($scope.Data);
                    var SaveAction = myService.UpdateData("/OrganizationUnitPlanImplementation/OrganizationUnitPlanImplementation_Save", $scope.ListData);
                    SaveAction.then(function (res) {
                        if (res.data.result.IsSuccess == true) {
