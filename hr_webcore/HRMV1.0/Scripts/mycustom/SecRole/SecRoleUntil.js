    ...
    app.controller(controllerName,
        function ($scope, myService, $filter) {
            ...
            $scope.editClick = function (contentItem) {
                ...
                var edit = myService.getDataById(contentItem.RoleID, $scope.tableInfo.id, $scope.tableInfo.DataEditUrl);
            ...
            $scope.deleteActionClick = function (obj) {
                ...
                var action = myService.deleteAction(obj.RoleID, $scope.tableInfo.id, $scope.tableInfo.DeleteUrl);
