...
//    _global.setCookie("fixHeader", $(this).is(":checked"), 999999);
//    _global.setCookie("fixNavigate", $(this).is(":checked"), 999999);
...
function Initmenu() {   
    //navigate
    var isFixNavigate = _global.getCookie("fixNavigate") == 'true' || _global.getCookie("fixNavigate") == '';
    if (isFixNavigate) {
        $.root_.addClass("fixed-navigation");
    }
    $('input[type="checkbox"]#smart-fixed-navigation').prop("checked", isFixNavigate);

    //header
    //var isFixHeader = (_global.getCookie("fixHeader") == 'true') || isFixNavigate;
    //if (isFixHeader) {
    //    $.root_.addClass("fixed-header");
    //}
    //$('input[type="checkbox"]#smart-fixed-header').prop("checked", isFixHeader);
}
...
$('input[type="checkbox"]#smart-fixed-navigation').click(function () {
    ...
    if($(this).is(":checked")) {
        ...
        _global.setCookie("fixHeader", true, 999999);
    }
    else {
...
$("#smart-styles > a").on("click", function () {
    _global.setCookie("skinId", $(this).attr("id"), 999999);
    ChangeSkin();
});

function ChangeSkin() {
    //var skinId = _global.getCookie("skinId");
    //if (skinId == '') {
    //    skinId = 'smart-style-3';
    //}
    //var a = $("#" + skinId), b = $("#logo img");
