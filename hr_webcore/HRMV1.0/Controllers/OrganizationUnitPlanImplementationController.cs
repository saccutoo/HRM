...
{
    public class OrganizationUnitPlanImplementationController : Controller
    {
        // GET: OrganizationUnitPlanImplementation
        [Permission(TableID = (int)ETable.OrganizationUnitPlanImplementation, TypeAction = (int)EAction.Index)]
        public ActionResult Index()
        {
            ViewBag.url = "/OrganizationUnitPlanImplementation/TableServerSideGetData";
            return PartialView();
        }

        [Permission(TableID = (int)ETable.OrganizationUnitPlanImplementation, TypeAction = (int)EAction.Get)]
        [WriteLog(Action = EAction.Get, LogStoreProcedure = "OrganizationUnitPlanImplementation_GetList")]
        ...
        [Permission(TableID = (int)ETable.OrganizationUnitPlanImplementation, TypeAction = (int)EAction.Submit)]
        [WriteLog(Action = EAction.Edit, LogStoreProcedure = "OrganizationUnitPlanImplementation_Save")]
        ...
        [Permission(TableID = (int)ETable.OrganizationUnitPlanImplementation, TypeAction = (int)EAction.Delete)]
        [WriteLog(Action = EAction.Delete, LogStoreProcedure = "OrganizationUnitPlanImplementation_Delete")]
        ...
        public ActionResult OrganizationUnitPlanImplementationSave()
        {
            return PartialView();
        }

        [Permission(TableID = (int)ETable.OrganizationUnitPlanImplementation, TypeAction = (int)EAction.Excel)]
        [WriteLog(Action = EAction.Excel, LogStoreProcedure = "OrganizationUnitPlanImplementation_GetList")]
        ...
        [Permission(TableID = (int)ETable.OrganizationUnitPlanImplementation, TypeAction = (int)EAction.Excel)]
        [WriteLog(Action = EAction.Excel, LogStoreProcedure = "ImPortOrganizationUnitPlanImplementation")]
