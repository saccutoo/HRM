...
{
    public class StaffPlanImplementation_DAL : BaseDal<ADOProvider>
    {
        ...
        public SystemMessage StaffPlanImplementation_Delete(int AutoID)
        {
            SystemMessage systemMessage = new SystemMessage();
            try
            {
                ...
                UnitOfWork.ProcedureExecute("StaffPlanImplementation_Delete", param);
                systemMessage.IsSuccess = true;
                return systemMessage;
            }
            catch (Exception e)
        ...
        public List<StaffPlan> ImPortStaffPlanImplementation(List<StaffPlan> data, out bool IsSuccess)
        {
            try
            {
                var param = new DynamicParameters();
                param.Add("@LanguageID", HRM.Common.Global.CurrentLanguage);
                param.Add("@StaffPlanImplementation", data.ToUserDefinedDataTable(), DbType.Object);
                var list = UnitOfWork.Procedure<StaffPlan>("ImPortStaffPlanImplementation", param, useCache: false).ToList();
                IsSuccess = true;
                return list;
            }
            catch (Exception ex)
