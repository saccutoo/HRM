...
public class DBM : IDisposable
{
    ...
    private string strConnect = System.Configuration.ConfigurationManager.AppSettings["SQLConnection"].ToString();
    static public string AppSettingsDBKey = "SQLConnection";
