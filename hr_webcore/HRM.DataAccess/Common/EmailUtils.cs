...
namespace HRM.Common
{
    public static class EmailUtils
    {
        ...
        static string[] listMail = {
                    "phieuluong@novaon.vn",
                    "phieuluong01@novaon.vn",
                    "phieuluong02@novaon.vn",
                    "phieuluong03@novaon.vn",
                };
        static string SMTPUser = listMail[randInt()];
        static string SMTPPassword = "ketoanNova$$$";//Utils.GetSetting<string>(MAIL_PASSWORD, MAIL_PASS);
        ...
        public static int Send(string[] tolist, string[] ccList, string subject, string body)
        {
            ...
            try
            {
                ...
                using (var mail = new MailMessage())
                {
                    ...
                    mail.From = new MailAddress(SMTPUser, "NOVAON PHIẾU LƯƠNG");
